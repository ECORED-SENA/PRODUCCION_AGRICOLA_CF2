...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    p 
      strong Tabla 1
    p.mb-2 Estándares mínimos del Sistema de Gestión de Seguridad y Salud en el Trabajo SG-SST
    ...
    .tabla-d.mb-4
      table
        ...
        thead
          tr
            th Ítem
            th.lineSD Criterios, empresas de diez o menos trabajadores clasificados en riesgo I, II, III
